...
<body id="bodystyle" >
	<div id="container">
		<header>
			...
			<img  id="imagen" width="50" src="imagenes/pastilla.jpg">
		...
		<div id="separador">
			<fieldset id="mapa">
					...
					<div id="carouselExampleCaptions" class="carousel slide " data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="imagenes/lutheria3" class="d-block w-100" alt="mantencion">
								<div class="carousel-caption d-none d-md-block">
									<h5 >Mantencion de los instrumentos</h5>
									<p >Calibracion de guitarras, bajos, violines etc.. revision GRATIS EN TIENDA boleta y trabajos garantizados.</p>
								</div>
							</div>
							<div class="carousel-item">
								<img src="imagenes/lutheria22" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
									<h5>Reparacion</h5>
							...
							<div class="carousel-item">
								<img src="imagenes/lutheria1" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
									<h5>calibracion</h5>
									<p>Calibracion de guitarras, bajos, violines etc.. revision GRATIS EN TIENDA boleta y trabajos garantizados somos el primer servicio tecnico especializado 100% en guitarras y bajos, precios modicos a convenir </p>
								</div>
							</div>
						</div>
				...
				<article id="article-inicio1">
					...
					<h2 class="h6">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
						consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
						cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
					proident, sunt in culpa qui officia deserunt mollit anim id est laborum.lorem</h2>
				</article>
			</div>
		</fieldset>
		<div class="clear"></div>
		<div class="card">
			...
			Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aspernatur, earum. Sequi explicabo nostrum asperiores cupiditate dicta exercitationem enim autem! Ipsam quidem impedit ad similique quasi vel perspiciatis reiciendis ab officia!
		</div>
	</div>
</div>
</body>
