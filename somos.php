...
<h5>ubicacion</h5>
			...
			<article class="articulo">
				...
				<p>nota: </p>
				<p>solo despachos a regiones dentro de chile</p>
			</article>
		...
		<div id="separador">
			<fieldset id="mapa">
				<h1 id=datusuario>Quiénes somos</h1>
				<section id="video">
					<iframe width="460" height="315" src="https://www.youtube.com/embed/biWk-QLWY7U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</section>
					<article id="article-inicio2">
			...
			<div class="clear"></div>
			<footer>
				<p> Instrumentos Musicales LB Luthuer ®™ - San Francisco 364, Santiago de Chile -
Fono: + 56 2 26391094 - Móvil: +56 9 92228854 - Email: contacto@mesko.cl
Horarios de Atencion: Lunes a Viernes de 10:00 a 14:00 Sabados: 10:00 a 14:00.
Redusoft</p>
			</footer>
		</div>
	</body>
