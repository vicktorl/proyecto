...
<body id="bodystyle" >
	<div id="container">
		...
		<div id="separador2">
			<fieldset id="mapa">
				<h3>porfavor califique segun su experiancia de usuario</h3>
				<?php
				$id=$_GET['id_trab'];
				$id_cliente=$_SESSION['usuario'];
				?>
				<a href="calificacion.php?id=1&id_trab=<?php echo$id?>"><img  id="star" src="imagenes/star.png"></a>
				<a href="calificacion.php?id=2&id_trab=<?php echo$id?>"><img  id="star" src="imagenes/star.png"></a>
				<a href="calificacion.php?id=3&id_trab=<?php echo$id?>"><img  id="star" src="imagenes/star.png"></a>
				<a href="calificacion.php?id=4&id_trab=<?php echo$id?>"><img  id="star" src="imagenes/star.png"></a>
				<a href="calificacion.php?id=5&id_trab=<?php echo$id?>"><img  id="star" src="imagenes/star.png"></a>
			</fieldset>
		</div>
		<div class="clear"></div>
	</div><footer>
