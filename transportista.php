	...
	<body id="bodystyle" >
		<div id="container">
			...
			<div class="clear"></div>
			<?php
			$id_transporte=$_SESSION['transp'];
			$sqlp="SELECT * from transporte where id='$id_transporte'";	
			...
			<div id="separador2">
				<fieldset id="mapa">
					<h1 id=datusuario>Hola <?php echo "$nombre" ?> </h1>
					<div class="tabla-1">
						<table class="table table-hover tabla-2">
							<?php
							$sqlp="SELECT * from transportista where id_trasportista='$id_transportista'";
							$result=mysqli_query($conectar,$sqlp);
							while($mostrar=mysqli_fetch_array($result)){
								?>
								<tr>
								...
								<?php $id_factura= $mostrar['id_cliente'] ?>
								<?php			
							}?>
						</table>
					</div>
					...
					<div class="tabla-1">
						<table class="table table-hover tabla-2">
							<?php	
							$sqlp="SELECT * from factura where id_factura='$id_factura'";
							$result=mysqli_query($conectar,$sqlp);
							while($mostrar=mysqli_fetch_array($result)){
								?>
								<tr>
								...
								<tr>
									<td class="tabla-casilla">Numero de factura</td>
									<td class="tabla-casilla"><?php echo $mostrar['id_factura'] ?></td>				
